...
public class SpringConfiguration implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(@NonNull ResourceHandlerRegistry registry) {
        /*
         * (if (environment.acceptsProfiles(Profiles.of("dev"))) { this.serveDirectory(registry,
         * "/dev-dashboard", "classpath:/dev_assets/"); }
         */
    ...
    private void serveDirectory(ResourceHandlerRegistry registry, @NonNull String endpoint,
